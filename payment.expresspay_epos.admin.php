...
class Payment_expresspay_epos_admin
{
	public $config;
	private $diafan;
	...
	public function __construct(&$diafan)
	{
		...
		$this->config = array(
			...
			"params" => array(
				...
				'eposCode' => array(
					'name' => 'Код в EPOS',
					'help' => 'Код в EPOS можно узнать в личном кабинете сервиса "Экспресс Платежи" в настройках услуги.'
				),
				'useSignature' => array(
    ...
    {
		$url = BASE_PATH.'payment/get/expresspay_epos';
