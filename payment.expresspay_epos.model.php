...
class Payment_expresspay_epos_model extends Diafan
{
	/**
	...
	public function get($params, $pay)
	{
		...
		if (isset($response['Errors'])) {
			...
			$epos_code  = $params['eposCode'] ."-";
			$epos_code  .= "1-";
			$epos_code .= $order_id;

			$output_error = str_replace('##ORDER_ID##', $epos_code,  $output_error);
            ...
            <tbody>
                    <tr>
                        ...
                        <h3>Ваш номер заказа: ##ORDER_ID##</h3>
                            ...
                            <br />2. В поле "Лицевой счет" введите <b>##ORDER_ID##</b> и нажмите "Продолжить" <br />
			...
			$output = str_replace('##ORDER_ID##', $epos_code,  $output);
